...
export const Responsive = ({ xsmall, small, medium, large, width, ...rest }) => {
  ...
  switch (width) {
    ...
    case "sm":
      element =
        typeof small !== "undefined" ? small : typeof medium !== "undefined" ? medium : large;
      break;
    case "md":
      element =
        typeof medium !== "undefined" ? medium : typeof large !== "undefined" ? large : small;
      break;
    case "lg":
    case "xl":
      element =
        typeof large !== "undefined" ? large : typeof medium !== "undefined" ? medium : small;
      break;
    default:
